...
pylab.title('Question 3 (Mantle)')
pylab.grid(True)
pylab.savefig('fisher_lab4_q3_mantle')
# 1 http://hittrackeronline.com/historic.php?id=2000_1
# 2 http://hittrackeronline.com/historic.php?id=1946_2
# 3 http://hittrackeronline.com/historic.php?id=1963_3
