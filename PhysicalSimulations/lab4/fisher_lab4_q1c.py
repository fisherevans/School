...
#pylab.plot(time, xExact, "ro", label="X Exact (No Drag/Magnus)")
#pylab.plot(time, data[1], "b-", label="Y RK4 (Drag + Magnus)")
#pylab.plot(time, yExact, "bo", label="Y Exact (No Drag/Magnus)")
...
pylab.title('Question 1c (Bottom)')
pylab.grid(True)
pylab.savefig('fisher_lab4_q1c_bottom')
