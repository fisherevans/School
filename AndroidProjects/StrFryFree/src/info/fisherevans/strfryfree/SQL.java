...
public class SQL
{
	...
	public static final String DB_VER = "/data/data/info.fisherevans.strfryfree/databases/wordsVersion.txt";
	public static final String DB_PATH = "/data/data/info.fisherevans.strfryfree/databases/";
